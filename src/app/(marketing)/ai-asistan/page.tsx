          ...
          <ScrollReveal>
            ...
            <div className="mt-6 flex flex-wrap gap-2">
              {scenarios.map((s) => (
                <span
                  key={s.text}
                  className="flex items-center gap-2 rounded-(--radius-sm) border border-hairline bg-surface px-3.5 py-2 text-[13px] text-ink transition-[transform,border-color] duration-(--motion-fast) ease-(--ease-out) hover:-translate-y-0.5 hover:border-gold-deep/40"
                >
